...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TK_INSERTAR = 3,                /* TK_INSERTAR  */
  YYSYMBOL_TK_EN = 4,                      /* TK_EN  */
  YYSYMBOL_TK_TABLA = 5,                   /* TK_TABLA  */
  YYSYMBOL_TK_VALORES = 6,                 /* TK_VALORES  */
  YYSYMBOL_TK_FIN = 7,                     /* TK_FIN  */
  YYSYMBOL_TK_IGUAL = 8,                   /* TK_IGUAL  */
  YYSYMBOL_TK_COMA = 9,                    /* TK_COMA  */
  YYSYMBOL_TK_DOSPUNTOS = 10,              /* TK_DOSPUNTOS  */
  YYSYMBOL_TK_PTOCOMA = 11,                /* TK_PTOCOMA  */
  YYSYMBOL_TK_ID = 12,                     /* TK_ID  */
  YYSYMBOL_TK_CADENA = 13,                 /* TK_CADENA  */
  YYSYMBOL_TK_BOOL = 14,                   /* TK_BOOL  */
  YYSYMBOL_TK_ENTERO = 15,                 /* TK_ENTERO  */
...
{
       0,   122,   122,   126,   146,   145,   178,   182,   199,   243,
     251,   262,   275
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TK_INSERTAR", "TK_EN",
  "TK_TABLA", "TK_VALORES", "TK_FIN", "TK_IGUAL", "TK_COMA",
  "TK_DOSPUNTOS", "TK_PTOCOMA", "TK_ID", "TK_CADENA", "TK_BOOL",
  "TK_ENTERO", "$accept", "programa", "sentencia", "$@1", "asignaciones",
  "asignacion", "valor", YY_NULLPTR
};
...
{
       2,     5,     4,   -13,     6,   -13,   -13,    -2,   -13,     7,
       8,     0,     9,    -1,   -13,   -12,     3,     0,   -13,   -13,
     -13,   -13,   -13,   -13,   -13
};
...
{
      18,    19,    20,    21,     5,     1,    16,     1,    17,     4,
       8,     7,    12,    10,    23,     6,     0,    15,    11,     0,
       0,     0,     0,     0,     0,     0,     0,    24
};

static const yytype_int8 yycheck[] =
{
      12,    13,    14,    15,     0,     3,     7,     3,     9,     4,
      12,     5,    12,     6,    11,     2,    -1,     8,    10,    -1,
      -1,    -1,    -1,    -1,    -1,    -1,    -1,    17
};
...
{
       0,     3,    17,    18,     4,     0,    18,     5,    12,    19,
       6,    10,    12,    20,    21,     8,     7,     9,    12,    13,
      14,    15,    22,    11,    21
};
...
#line 146 "sql.y"
        {
             ...
             */
            strncpy(tabla_actual, (yyvsp[0].sval), sizeof(tabla_actual) - 1);
            tabla_actual[sizeof(tabla_actual) - 1] = '\0';
            campos_buf[0]  = '\0';   /* limpiar buffer de campos  */
            valores_buf[0] = '\0';   /* limpiar buffer de valores */
            free((yyvsp[0].sval));                /* liberar la copia de strdup */
        }
#line 1151 "sql.tab.c"
    break;

  case 5: /* sentencia: TK_INSERTAR TK_EN TK_TABLA TK_ID $@1 TK_VALORES TK_DOSPUNTOS asignaciones TK_FIN TK_PTOCOMA  */
#line 159 "sql.y"
        {
            /*
...
#line 1165 "sql.tab.c"
  ...
  case 6: /* asignaciones: asignacion  */
#line 179 "sql.y"
        {
...
#line 1173 "sql.tab.c"
  ...
  case 7: /* asignaciones: asignaciones TK_COMA asignacion  */
#line 183 "sql.y"
        {
...
#line 1181 "sql.tab.c"
  ...
  case 8: /* asignacion: TK_ID TK_IGUAL valor  */
#line 200 "sql.y"
        {
            /*
            ...
            strncat(campos_buf, (yyvsp[-2].sval),
                    sizeof(campos_buf) - strlen(campos_buf) - 1);
            ...
            strncat(valores_buf, (yyvsp[0].sval),
                    sizeof(valores_buf) - strlen(valores_buf) - 1);

            free((yyvsp[-2].sval));   /* liberar copia de strdup del campo  */
            free((yyvsp[0].sval));   /* liberar copia de strdup del valor  */
        }
#line 1216 "sql.tab.c"
    break;

  case 9: /* valor: TK_CADENA  */
#line 244 "sql.y"
        {
            /*
             ...
             */
            (yyval.sval) = (yyvsp[0].sval);   /* propagamos el sval directamente */
        }
#line 1228 "sql.tab.c"
    break;

  case 10: /* valor: TK_ENTERO  */
#line 252 "sql.y"
        {
            /*
            ...
            snprintf(buf, 16, "%d", (yyvsp[0].ival));
            (yyval.sval) = buf;
        }
#line 1243 "sql.tab.c"
    break;

  case 11: /* valor: TK_BOOL  */
#line 263 "sql.y"
        {
            /*
